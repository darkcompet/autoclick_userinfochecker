...
public class BhxhHelper {
   public static void addTitleRows(int titleRowIndex, MySheet inSheet, MySheet outSheet) {
   ...
   public static void addNoResultRow(int rowIndex, int START_READ_ROW_INDEX, MySheet inSheet, MySheet outSheet) {
      List<String> patchRow = inSheet.getRowAt(rowIndex);
      List<String> newRow = new ArrayList<>();
   ...
   public static void addRows(int rowIndex, int START_READ_ROW_INDEX, MySheet inSheet, List<BhxhResultRow> addRows, MySheet outSheet) {
   ...
   public static void collectInfoFromResultRow(BhxhResultRow resultRow, List<WebElement> cols) {
      try {
