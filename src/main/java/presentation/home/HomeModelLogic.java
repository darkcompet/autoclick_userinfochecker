...
public class HomeModelLogic implements Callback {
   ...
   public void log(String format, Object... args) {
      ...
      LogItemModel logItemModel = new LogItemModel();
      logItemModel.created = new SimpleDateFormat("HH_mm_ss-dd_MM_yyyy").format(new Date());
      logItemModel.msg = msg;
   ...
   private void writeLogToFileAndCleanupOnMainThread() {
      Platform.runLater(() -> {
         String time = new SimpleDateFormat("HH_mm_ss yyyy-MM-dd").format(new Date());
